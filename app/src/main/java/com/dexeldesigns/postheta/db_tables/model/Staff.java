...
public class Staff {
    ...
    @ToMany(referencedJoinProperty = "staffId")
    private List<Clock> clockdata;
    ...
    @Generated(hash = 663282187)
    public Staff(Long id, String name, String pin) {
        this.id = id;
        this.name = name;
        this.pin = pin;
    }
    ...
    public List<Clock> getClockdata() {
        if (clockdata == null) {
            ...
            List<Clock> clockdataNew = targetDao._queryStaff_Clockdata(id);
            synchronized (this) {
                if (clockdata == null) {
                    clockdata = clockdataNew;
                }
            }
        }
        return clockdata;
    ...
    @Generated(hash = 453185623)
    public synchronized void resetClockdata() {
        clockdata = null;
    }
