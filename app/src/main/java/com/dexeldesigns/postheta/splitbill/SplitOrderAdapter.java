...
/**
 * Created by Creative IT Works on 24-Apr-17.
 */

public class SplitOrderAdapter  extends RecyclerView.Adapter<SplitOrderAdapter.MyViewHolder> {
    ...
    public SplitOrderAdapter(Activity context, List<OrderItems> order) {
    ...
    @Override
    public SplitOrderAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType)  {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.orders_item, parent, false);

        return new SplitOrderAdapter.MyViewHolder(itemView);
    }
    ...
    @Override
    public void onBindViewHolder(final SplitOrderAdapter.MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SplitFragment.menu=order.get(position);
